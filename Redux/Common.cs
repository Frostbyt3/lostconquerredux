    ...
    public static class Common
    {
        ...
        public static Tuple<ConquerItem, string, LotteryItemType> QurryLotteryItem()
        {
            ...
            if (CategoryRandomness < 50)
                ...
                ItemType = LotteryItemType.Germant;
